...
<html lang="vi">
  ...
  <body>
      ...
      <div class="main-profile">
        ...
        <div id="settingsMenu" style="display: none">
          <ul>
            ...
            <li data-section="logout">Đăng xuất</li>
          </ul>
        </div>
    ...
    <script src="../asset/javaCript/jquery.min.js"></script>
    <script>
      $(document).ready(function () {
        function renderContent(content) {
          $("#output-area").html(`<div class="section">${content}</div>`);
        }

        $("#article-saved").click(function () {
          renderContent(
            "<h3>Bài viết đã lưu</h3><p>Danh sách bài viết đã lưu hiển thị tại đây.</p>"
          );
        });

        $("#your-blog").click(function () {
          renderContent(
            "<h3>Blog của tôi</h3><p>Nội dung blog cá nhân hiển thị tại đây.</p>"
          );
        });

        $("#my-article").click(function () {
          renderContent(
            "<h3>Bài viết của bạn</h3><p>Danh sách bài viết bạn đã tạo hiển thị tại đây.</p>"
          );
        });
        ...
        $("#settingsMenu li[data-section]").click(function () {
          ...
          $("#personalPage").hide();
          $("#settingContent").load(`./Cai-dat/${section}.html`).show();
          $("#settingsMenu").hide();
        });
