...
-- Thời gian đã tạo: Th5 12, 2025 lúc 02:39 PM
...
(22, 'Anime', 'uploads/z6590499652235_e9679eb37f33672b8ffa2ffb6a4b317b.jpg', 25, '2025-05-11', 0, 'con hươu', '', 0),
(23, 'Tranh ', 'uploads/500px-Vincent_van_Gogh_-_Brug_in_de_regen-_naar_Hiroshige_-_Google_Art_Project.jpg', 8, '2025-05-12', 0, 'tranh của van-goh', '', 0),
(29, 'Con mèo', 'uploads/tải xuống.jpg', 8, '2025-05-12', 0, 'đáng yêu quá đi', '', 0),
(30, 'Vô tri', 'uploads/meme-meo-cuoi-5.jpg', 8, '2025-05-12', 0, 'ahahhaha', '', 0);
...
--
ALTER TABLE `upload_picture`
  MODIFY `idPic` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=31;
COMMIT;
